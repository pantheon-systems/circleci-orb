...
| `resource_class`      | string  | `"medium"`       | no       | The size/available memory for the container. This may need to be increased if memory-intensive build steps run in pre- or post steps. https://circleci.com/product/features/resource-classes/ |
